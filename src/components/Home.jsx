...
function Home() {
  ...
  return (
    <div
      className={`flex flex-col h-screen w-screen items-center justify-center gap-4 bg-[#DAF1DD] dark:bg-[#002339]
        dark:text-white text-cyan-900 `}    >

      {/* ---------------------------------------------------Toggle Theme Button------------------------------------------------ */}
            
      <button className="absolute top-8 right-5 sm:right-8 "  onClick={() => onToggleTheme()}>
        {isDark ? <CiLight size={32} title={'light mode'} /> : <MdNightlight size={28} title="dark mode" color="#164E63" />}
      </button>
